...
function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 flex flex-col justify-evenly">
      <div className="text-center">
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-2">ENT Shatibi</h1>
        <p className="text-gray-600 text-lg">Votre espace numérique de travail</p>
      </div>
